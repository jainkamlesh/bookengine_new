    ...
    <section class="dashboard-wrapper property-wrapper booking-wrapper">
        <div class="container-fluid">
            <ul id="breadcrumb" class="p-0">
                ...
                <li><a href="{{route('admin.service.booking')}}"><span class="icon icon-beaker"> </span>{{ __('user.calendar') }}</a></li>
            </ul>
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function displayListData() {
                ...
                var urlData = "{!! route('admin.service.list.booking.data') !!}";
