...
@section('content')
    <section class="dashboard-wrapper property-wrapper booking-wrapper">
        ...
        <div class="container-fluid calendar-wrapper">
            <form  action="{{ route('admin.hotel.requests.booking.upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="d-flex align-items-right nav-br">
                        <div class="form-group my-3">
                            <label class="m-0">{{ __('label.selectexcelfile') }} :</label><br>
                            <input type="file" name="bulk_file" class="form-control" id="bulk_file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                        </div>
                        <div class="form-group my-3">
                            <button type="submit" class="btn btn-default btn-save mt-4">{{ __('label.upload') }} <i class="fa fa-upload" aria-hidden="true"></i></button>
                        </div>
                    </div>
                </form>
                ...
                <div class="d-flex align-items-center nav-br">
                    <div class="form-group my-3">
                        ...
                        <select class="js-states form-control single" id="select_search_by">
                            <option value="booking_date">{{ __('user.bookingrequestdate') }}</option>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function displayListData() {
                ...
                var urlData = "{!! route('admin.hotel.requests.booking.data') !!}";
